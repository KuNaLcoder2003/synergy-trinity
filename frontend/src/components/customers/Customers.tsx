...
import useCutomers from "./hooks/useCustomer"
import { DeleteIcon, Eye, Loader } from "lucide-react"
import { useState } from "react"
import CustomerForm from "./CustomerForm"

const CustomersTab: React.FC = () => {
    const { customers, loading, error } = useCutomers()
        ...
        <>
            {
                loading ? <div className="w-full h-full flex items-center justify-center">
                    ...
                    {
                        addCustomerModal && <div className="absolute inset-0 bg-black/20 p-2 flex items-center justify-center">
                            <div className="w-7xl">
                                <CustomerForm onClose={setAddCustomerModal} />
                            </div>
                        </div>
                    }
...
export const CustomerRow: React.FC<{ customer: Customers }> = ({ customer }) => {
    return (
